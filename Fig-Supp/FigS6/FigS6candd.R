...
infile <- read.table("./FigS6/retrained-AUC.txt",sep='\t',stringsAsFactors = F, header = T)
...
ggsave("./FigS6/retrained-AUC-compare.pdf", width = 9, height = 8, units = "cm")


#=========================AUCPRC============================================

infile <- read.table("./FigS6/retrained-AUPRC.txt",sep='\t',stringsAsFactors = F, header = T)
colnames(infile) <- c("Assay Categories","DeepSEA Testing Dataset","CARMEN Testing Dataset")
infilep <-melt(infile) 
...
ggsave("./FigS6/retrained-AUPRC-compare.pdf", width = 9, height = 8, units = "cm")
