...
eur = pd.read_csv("./FigS8/04-01-European-result.txt",header=None)
han = pd.read_csv("./FigS8/04-02-Han-result.txt",header=None)
afi = pd.read_csv("./FigS8/04-03-African-result.txt",header=None)
...
pp = PdfPages('./FigS8/04-histogram.pdf')
pp.savefig(fig)
pp.close()
