...
data_plot.loc[data_plot['rs']=="rs1421085",'snptype'] = 'best-ld'
...
for iterm in [1,0,2]:
    ...
    if label_in == 'lead':
        ax.annotate(data_plot[data_plot['snptype'] == 'lead']['rs'].values[0],(x,y+0.002),fontsize=10)
    if label_in == 'best-ld':
        ax.annotate(data_plot[data_plot['snptype'] == 'best-ld']['rs'].values[0],(x+3000,y),fontsize=10)
...
ax.set_ylim(-0.01,0.150001) # To make the y axis label in the middle position
