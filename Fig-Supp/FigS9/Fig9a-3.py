...
data_plot.loc[data_plot['rs']=="rs200996365",'snptype'] = 'best-ld'
...
for iterm in [1,0,2]:
    ...
    if label_in == 'lead':
        ax.annotate(data_plot[data_plot['snptype'] == 'lead']['rs'].values[0],(x+1000,0),fontsize=10)
    if label_in == 'best-ld':
