...
data_file = pd.read_csv('./FigS7/ExPecto.snplabel.csv')
...
data_file = pd.read_csv('./FigS7/CARMEN_filter_NULL.txt')
label = data_file.iloc[:,6]
...
data_file = pd.read_csv('./FigS7/EnsembleExpr_filter_NULL.txt',header=None,sep='\t')
...
data_file = pd.read_csv('./FigS7/CADD_filter_NULL.txt',header=None,sep='\t')
label = data_file.iloc[:,5]
...
data_file = pd.read_csv('./FigS7/Deepsea_filter_NULL.txt',header=None,sep='\t')
label = data_file.iloc[:,5]
...
data_file = pd.read_csv('./FigS7/Funseq2_filter_NULL.txt',header=None,sep='\t')
label = data_file.iloc[:,5]
predict = data_file.iloc[:,7]
result = confusion_matriloc_calculate(label,predict)
...
data_file = pd.read_csv('./FigS7/Eigen_filter_NULL.txt',header=None,sep='\t')
label = data_file.iloc[:,5]
predict = data_file.iloc[:,7]
result = confusion_matriloc_calculate(label,predict)
result.append("Eigen")
...
data_file = pd.read_csv('./FigS7/GWAVA_filter_NULL.txt',header=None,sep='\t')
label = data_file.iloc[:,5]
predict = data_file.iloc[:,7]
result1 = confusion_matriloc_calculate(label,predict)
...
data_file = pd.read_csv('./FigS7/BiT_LCL_DNase_result_final_merge.txt',header=None,sep='\t')
...
data_file = pd.read_csv('./FigS7/BiT_LCL_H3K27AC_result_final_merge.txt',header=None,sep='\t')
label = data_file.iloc[:,0]
predict = data_file.iloc[:,2].abs()
result = confusion_matriloc_calculate(label,predict)
...
data_file = pd.read_csv('./FigS7/BiT_LCL_H3K4ME1_result_final_merge.txt',header=None,sep='\t')
label = data_file.iloc[:,0]
predict = data_file.iloc[:,2].abs()
result = confusion_matriloc_calculate(label,predict)
...
data_file = pd.read_csv('./FigS7/BiT_LCL_H3K4ME3_result_final_merge.txt',header=None,sep='\t')
label = data_file.iloc[:,0]
predict = data_file.iloc[:,2].abs()
result = confusion_matriloc_calculate(label,predict)
...
data_file = pd.read_csv('./FigS7/BiT_ncER_result_final_merge.txt',header=None,sep='\t')
