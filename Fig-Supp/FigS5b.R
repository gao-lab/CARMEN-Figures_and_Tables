...
input <- read.table("./FigS5/CARMEN-annotation-AUC-removeENCODEblacklist.txt",header = T,stringsAsFactors = F,sep='\t')
...
ggsave("./FigS5/Annotations-AUC-boxplot-removeENCODEblacklist.pdf", width = 8.5, height = 6, units = "cm")
