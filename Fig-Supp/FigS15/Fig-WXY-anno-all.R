...
infile <- read.table("WXY-anno-all.txt",sep='\t',stringsAsFactors = F, header = T)
infile['Mean.annotation.num'] <- as.numeric(unlist(infile['Mean.annotation.num']))
#============================Wilcox test==============================================
...
ggsave("WXY-anno-all.pdf", width = 8, height = 8, units = "cm")
