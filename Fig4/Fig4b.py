...
#========================Load data and merge===========================================
data = pd.read_table("./Fig4a-d/luciferase-case1.txt")
...
ax.set_ylim(0,1.2000000000001)	

ax.annotate("ns",(1.3,0.25),fontsize=10)	
ax.annotate("****",(3.1,1.0),fontsize=10)
ax.annotate("p = 3.6e-06",(2.8,1.1),fontsize=10)
ax.annotate("rs1701704",(1.0,0.35),fontsize=10)
ax.annotate("rs705698",(2.9,1.2),fontsize=10)
...
pp = PdfPages('./Fig3a-d/CASE1-luciferase.pdf')
pp.savefig(fig)
pp.close()
