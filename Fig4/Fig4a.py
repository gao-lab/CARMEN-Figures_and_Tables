...
for iterm in [1,0,2]:
    ...
    if label_in == 'lead':
        ax.annotate(data_plot[data_plot['snptype'] == 'lead']['rs'].values[0],(x,y+0.02),fontsize=10)
    if label_in == 'best-ld':
...
ax.set_ylim(-0.01,0.500001) # To make the y axis label in the middle position
